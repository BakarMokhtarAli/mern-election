...
import { useUpdateCandidatePasswordMutation } from "../../store/api/CandidateSlice";
import { Loading } from "../../utils";
import toast from "react-hot-toast";
import { useTitle } from "../../Hooks/useTitle";

export const UpdateCandidatePassword = () => {
  //   const { id } = useParams();
  const [updateCandidatePassword] = useUpdateCandidatePasswordMutation();
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const data = await updateCandidatePassword(updatedPassword).unwrap();
      console.log(data);
      setLoading(false);
